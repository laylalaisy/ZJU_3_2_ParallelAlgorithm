...
当信号传递到底部的时候就可以得到预期的 a_0k 了。

![Tree](02-tree.gif)

![prefix-sum](02-prefix-sum_3.JPG )

![prefix-sum](02-prefix-sum_4.jpg )
...
1. Bucket Sorting
    ...
    对于 n 个 numbers，我们把它分成 n/p 组，每组有 p 个。
    然后我们准备 types数的种类数，这里我们假设为 n/p种桶，对于每个桶我们准备 p个槽。
    所以对于某个处理器i正在处理的数 x，我们首先基于 x找到其对应的桶，
    然后根据处理器的序号 i找到对应的槽，放入。
